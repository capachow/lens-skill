...
**PROTOCOL:**
0. **Self-Repair & Sync:** 
   - Check if `.lens/SET.json` exists and `meta.version` is "0.7.0". If missing or outdated, run `skills/lens/scripts/bootstrap.js` immediately to align the environment before proceeding.
